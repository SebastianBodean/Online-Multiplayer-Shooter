...
//  TODO: Rename this to something like player, and all the other functions to things like movement, health, inventory, etc. so you can access shit like player.health
public class Player : NetworkBehaviour
{
    public NetworkVariable<Vector2> movementInput = new NetworkVariable<Vector2>();
    public NetworkList<bool> inputs = new NetworkList<bool>();

    #region ControllStates
    //public System.Action SetFocus = null;
    /// <summary>
    ...
    /// <summary>
    /// All the components used by the player
    /// </summary>
    #region Components
